...
# ‑‑‑ 配置‑‑‑
# 确保环境变量已设置API 密钥（如GOOGLE_API_KEY）
try:
    llm = ChatOpenAI(
...
# ‑‑‑ 定义协调者路由链（等同于ADK 协调者指令）‑‑‑
coordinator_router_prompt = ChatPromptTemplate.from_messages(
    [
        (
            "system",
            """分析用户请求，判断应由哪个专属处理器处理。
